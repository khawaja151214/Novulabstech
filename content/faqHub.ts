...
export const hubFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'We describe alignment with these standards, not certification against them. Where this site says our engineering practice follows a standard, it means the practice follows it — not that a registrar has audited us. HIPAA has no certification regime at all; organisations attest to compliance. Where a framework does issue certification, that certificate is held by the institution operating the environment, not by its development vendor.',
  },
];
